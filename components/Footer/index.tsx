...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp dark:bg-black bg-white pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Start your journey with Epickart and create the perfect PC that matches your style and performance needs. Customization made easy and exciting!
                </p>
